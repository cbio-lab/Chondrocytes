...
write.table(cbind(gene_id = rownames(res_chondro_GG), res_chondro_GG),
            file = "~/Desktop/GitHub/Chondro/case_vs_control/case_vs_control.tsv", sep = "\t", quote = F)
# Points (>= | <=)
...
#| warning: false
#| cache: true
custome_UR_1 <- read.xlsx(xlsxFile = "~/Desktop/GitHub/Chondro/case_vs_control/UR/(+)Mixed, incl. Amplification of signal from the kinetochores, and Condensin complex.xlsx",
                          colNames = T)
...
#| warning: false
#| cache: true
custome_DR_1 <- read.xlsx(xlsxFile = "~/Desktop/GitHub/Chondro/case_vs_control/DR/(-)ECM-receptor interaction+Extracellular matrix organization.xlsx",
                          colNames = T)
...
#| warning: false
#| cache: true
custome_DR_2 <- read.xlsx(xlsxFile = "~/Desktop/GitHub/Chondro/case_vs_control/DR/(-)Interferon alphabeta signaling+Defense response to virus+Antiviral defense.xlsx",
                          colNames = T)
...
write.table(file = "~/Desktop/GitHub/Chondro/case_vs_control/case_vs_control_gene_set.tsv",
...
metadata_for_chondro <- read.csv(file = "~/Desktop/GitHub/Chondro/chondro_metadata/ensbl2geneid.tsv", sep = '\t')
...
#| warning: false
# GSEA
data_genes <- read.csv(file = "~/Desktop/GitHub/Chondro/chondro_metadata/ensbl2geneid.tsv",
                       header = TRUE, sep = '\t')
...
write.table(x = gsea_df_green,file = "~/Desktop/GitHub/Chondro/case_vs_control/green_module/green_module_coex.xlsx")
...
write.table(x = gsea_df_greenyellow,file = "~/Desktop/GitHub/Chondro/case_vs_control/greenyellow_module_coex.xlsx")
...
#| warning: false
#| cache: true
gsea_df_green <- read.xlsx(xlsxFile = "~/Desktop/GitHub/Chondro/case_vs_control/green_module/module_green_coex2.xlsx", sheet = TRUE, sep = '\t')
...
#| warning: false
#| cache: true
gsea_df_greenyellow <- read.xlsx(xlsxFile = "~/Desktop/GitHub/Chondro/case_vs_control/module_yellowgreen_coex2.xlsx", sheet = TRUE, sep = '\t')
...
# data from COex
# green_module
data_coex_green <- read.xlsx(xlsxFile = "~/Desktop/GitHub/Chondro/case_vs_control/green_module/module_green_coex2.xlsx", colNames = T, sheet = T)
colnames(data_coex_green)[12] <- 'genes'

data_coex_greenyellow <- read.xlsx(xlsxFile = "~/Desktop/GitHub/Chondro/case_vs_control/module_yellowgreen_coex2.xlsx", colNames = T, sheet = T)
# greenyellow_module
...
green_string_data <- read.xlsx(xlsxFile = "~/Desktop/GitHub/Chondro/case_vs_control/green_module/1. Focal adhesion + Extracellular matrix organization (green_modul_cluster).xlsx", sheet = T, colNames = T)
...
file = "~/Desktop/GitHub/Chondro/case_vs_control/custom_green_module_df.tsv", quote = F, sep = '\t')
# GSEA
