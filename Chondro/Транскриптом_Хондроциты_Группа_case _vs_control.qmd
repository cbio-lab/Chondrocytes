``` r
---
title: "Транскриптом_Хондроциты_Группа_case_vs_control"
format: html
editor: visual
---
```
...
```{r}
#| cache: true
knitr::include_graphics("~/Desktop/GitHub/Chondro/PCA.pdf")
knitr::include_graphics("~/Desktop/GitHub/Chondro/DESeq2.pdf")
```
...
![](images/clipboard-3868221620.png)
...
![](images/clipboard-3914991167.png)
...
![](images/clipboard-549467128.png)
